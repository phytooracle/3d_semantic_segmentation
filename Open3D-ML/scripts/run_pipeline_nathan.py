...
def main():
    ...
    if args.cfg_file is not None:
        ...
        dataset = Supervisely('/home/equant/work/sandbox/3D/open3dml/lettuce_semantic_segmentation/converted_to_o3d_dataset',train_dir='train', test_dir='test', val_dir='val')
        ...
        from supervisely_dataset import Supervisely
        #from _ml3d.datasets.supervisely import Supervisely
